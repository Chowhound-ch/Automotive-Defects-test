<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="${comment}" prop="defectId">
        <el-input
    ...
    <el-table v-loading="loading" :data="resultList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="resultId" />
      <el-table-column label="${comment}" align="center" prop="recordId" />
      <el-table-column label="${comment}" align="center" prop="url" />
      <el-table-column label="${comment}" align="center" prop="defectId" />
      <el-table-column label="${comment}" align="center" prop="isDelete" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="${comment}" prop="defectId">
          <el-input v-model="form.defectId" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="isDelete">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除识别结果编号为"' + resultIds + '"的数据项？').then(function() {
